...
<head>
    ...
    <title>Iron Gym | Ver Miembros</title>
							    ...
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							        ...
							        if (mysqli_affected_rows($con) == 1) {
							            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
							                ...
							                echo "<td><form action='ver_todo_detalle.php' method='post'>
											<input type='hidden' name='name' value='" . $uid . "'/>
											<input type='submit' class='a1-btn a1-blue' id='button1' value='Ver Todo ' class='btn btn-info'/>
											</form></td></tr>";
							                $msgid = 0;
							            }
							        }
