...
if(isset($_POST['submit'])){
	...
	$query="update estado_salud set calorias='".$calorie."', altura='".$height."',peso='".$weight."',grasa='".$fat."',observaciones='".$remarks."' where id_usuarioo='".$userid."'";
	...
	if(mysqli_query($con,$query)){
	 ...
	 echo "<head><script>alert('NO EXITOSO,Verifique de nuevo');</script></head></html>";
	...
	$sql="select * from estado_salud where id_usuarioo='".$uid."'";
...
<head>
   ...
   <title>Iron Gym | Entrada de estado de salud</title>
